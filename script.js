/* ============================================================
   ...
   Implementação completa e estável
   ============================================================ */
...
/* ============================================================
   ...
   Substitua pela lista completa com 2200 nomes
   ============================================================ */
...
/* ============================================================
   FUNÇÃO DE CANDIDATOS (ciclo + janela de 6 letras)
   ============================================================ */
...
function findApproxCandidates(gender, length, letters, pigbackFirstReal) {
  ...
  const inputLetters = letters.map(ch =>
    normalize(ch || "").charAt(0)
  );
  ...
  NAMES.forEach(n => {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      const diff = (t - r + ALPHABET.length) % ALPHABET.length;
...
function swipeModeDown() {
  if (swipeStage === "gender") swipeGender = "F";
    ...
    let idx = ALPHABET.index.indexOf(swipeLetterChar);
...
/* ============================================================
   GRADE MODE (setup → letras → resultado)
   ============================================================ */
...
function updateGradeLettersDisplay() {
  $("gradeLettersDisplay").innerText = gradeLetters.join(" ");
}
...
function startMode(m) {
  ...
  else if (m === "pigback") startPigback();
  else if (m === "grade") startGrade();
  else if (m === "lexicon") startLexicon();
  else goHome(true);
}

/* ============================================================
   2 DEDOS PARA VOLTAR AO MENU
   ============================================================ */
